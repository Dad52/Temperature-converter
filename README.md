<h1 align="center">Добро пожаловать в конвертер температур! 👋</h1>
<p>
...
*P.S. Обновление в Google Play загружаю не сразу + оно требует проверки, поэтому версия, скриншоты и функционал могут немного отличаться на гите и в Google Play*
## Как использовать?
